...
> **Status:** Superseded historical implementation plan. Do not send its reply,
> change metadata, archive, upload, or resubmit from this file. The active
> rejection is under guideline 2.5.2. See
> [`../ios-app-review.md`](../ios-app-review.md) and
> [`../app-store-v1.0-metadata.md`](../app-store-v1.0-metadata.md).
> The old website screenshot paths below no longer exist. Current release
> assets are indexed in `ios/AppStore/Screenshots/README.md`.
